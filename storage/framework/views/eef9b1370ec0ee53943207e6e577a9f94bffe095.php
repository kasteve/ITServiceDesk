...
<body>
    ...
    <div class="sidebar">
        <ul>
            <?php if(auth()->guard()->check()): ?> <!-- Check if the user is authenticated -->
                <li class="active">
                    <a href="#">Issues</a>
                    <ul class="submenu">
                        <!-- Show "Add New Issue" link to regular user -->
                        <?php if(auth()->check() && auth()->user()->role->name === 'regular user'): ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="action-links">
                        <p><strong>Accumulated issues:</strong> <span class="record-count"><?php echo e($data->count()); ?></span></p>
                        <div class="ms-auto">
...
<?php /**PATH C:\Users\stephen.kakaire\Documents\SteveTech\resources\views/myroute.blade.php ENDPATH**/ ?>