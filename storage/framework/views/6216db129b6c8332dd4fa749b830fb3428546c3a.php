                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <label for="issue_name">Issue Category</label>
                            <select class="form-control" name="issue_name" value="<?php echo e(old('issue_name')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" name="time_of_reporting" value="<?php echo e(old('time_of_reporting') ? \Carbon\Carbon::parse(old('time_of_reporting'))->format('Y-m-d\TH:i') : ''); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="assigned_to" value="<?php echo e(old('assigned_to')); ?>">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="second_assigned_to" value="<?php echo e(old('second_assigned_to')); ?>">
                                <option value="">Select Resource</option>
                                <option value="alibakastephen256@gmail.com">Technical Support(Stephen K)</option>
                            </select>
                            <span class="text-danger"><?php $__errorArgs = ['second_assigned_to'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="priority" value="<?php echo e(old('priority')); ?>">
                                <option value="low">Low</option>
                                <option value="medium">Medium</option>
                                <option value="high">High</option>
                            </select>
                            <span class="text-danger"><?php $__errorArgs = ['priority'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comment" rows="2"><?php echo e(old('comment')); ?></textarea>
...
<?php /**PATH C:\Users\stephen.kakaire\Documents\SteveTech\resources\views/auth/add-issue.blade.php ENDPATH**/ ?>