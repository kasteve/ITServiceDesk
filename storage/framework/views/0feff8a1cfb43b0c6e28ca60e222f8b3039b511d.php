...
<body>
    ...
    <div class="add-issue-container">
        <div class="add-issue-form">
            ...
            <form action="<?php echo e(route('add-issue')); ?>" method="POST"><br>
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    <label for="reporter_name">Full Names</label>
                    <input type="text" class="form-control" placeholder="Enter your name" name="suggested_by" value="<?php echo e(old('suggested_by')); ?>">
                    <span class="text-danger"><?php $__errorArgs = ['suggested_by'];
...
unset($__errorArgs, $__bag); ?></span>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="suggestion" rows="4" placeholder="Please give sufficient details............."><?php echo e(old('suggestion')); ?></textarea>
...
<?php /**PATH C:\Users\stephen.kakaire\Documents\SteveTech\resources\views/suggestions.blade.php ENDPATH**/ ?>