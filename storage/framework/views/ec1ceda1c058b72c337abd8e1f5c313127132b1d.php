            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="action-links">
                        <p><strong>Unattended issues:</strong> <span class="record-count"><?php echo e($data->count()); ?></span></p>
                        <div class="ms-auto">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($issue->second_assigned_to); ?></td>
                                    <td id="sla-<?php echo e($issue->id); ?>"></td>

                                    <td>
                                        <a href="<?php echo e(route('update-issue', ['id' => $issue->id])); ?>" class="btn btn-primary me-2">Update</a>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.70/vfs_fonts.js"></script>
  <script>
    $(document).ready(function () {
        ...
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            calculateSLA("<?php echo e($issue->reported_at); ?>", "<?php echo e($issue->priority); ?>", "<?php echo e($issue->id); ?>");
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\stephen.kakaire\Documents\SteveTech\resources\views/detailed_report.blade.php ENDPATH**/ ?>